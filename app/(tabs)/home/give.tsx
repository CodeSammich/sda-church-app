...
export default function GiveScreen() {
  ...
  const allLabels = {
    en: {
      ...
      dafTitle: 'New York Chinese Seventh-day Adventist Church',
      dafDesc:
        'To recommend a grant through Fidelity Charitable, search for New York Chinese Seventh-day Adventist Church using EIN 11-3004814.',
      quote:
    ...
    zh: {
      ...
      dafSection: '捐贈者建議基金',
      dafLabel: 'Fidelity Charitable',
      dafTitle: '紐約華人基督復臨安息日會',
      dafDesc:
        '如要透過 Fidelity Charitable 建議撥款，請使用 EIN 11-3004814 搜尋「紐約華人基督復臨安息日會」。',
      quote:
    ...
    'zh-cn': {
      ...
      dafSection: '捐赠者建议基金',
      dafLabel: 'Fidelity Charitable',
      dafTitle: '纽约华人基督复临安息日会',
      dafDesc:
        '如要通过 Fidelity Charitable 建议拨款，请使用 EIN 11-3004814 搜索“纽约华人基督复临安息日会”。',
      quote:
    ...
    es: {
      ...
      dafTitle: 'New York Chinese Seventh-day Adventist Church',
      dafDesc:
        'Para recomendar una donación mediante Fidelity Charitable, busque New York Chinese Seventh-day Adventist Church con el EIN 11-3004814.',
      quote:
