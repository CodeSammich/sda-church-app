...
import { CHURCH_BUILDING_IMAGE_URL, openURL } from '@/constants/ExternalLinks';
...
import { CHINESE_LIBRARY_URL } from '@/features/library/ChineseLibrary';
import {
...
const sourceCopy = {
  en: {
    ...
    chineseLibrary: 'Chinese-language books and study resources open externally on the Chinese Union Mission library.',
  ...
  zh: {
    ...
    chineseLibrary: '中文書籍與研經資源將在華安聯合會圖書館外部網站開啟。',
  ...
  'zh-cn': {
    ...
    chineseLibrary: '中文书籍与查经资源将在华安联合会图书馆外部网站打开。',
  ...
  es: {
    ...
    chineseLibrary: 'Los libros y recursos de estudio en chino se abren externamente en la biblioteca de la Unión China.',
      ...
      >
        ...
        <SourceNoticePanel
          items={[
            ...
            { icon: 'web', text: sourceLabels.chineseLibrary },
        ...
        <List.Section>
          ...
          <MenuCard
            title={labels.chineseLibrary}
            description={labels.chineseLibrarySub}
            icon="web"
            onPress={() => openURL(CHINESE_LIBRARY_URL, labels.title, sourceLabels.chineseLibrary)}
          />
