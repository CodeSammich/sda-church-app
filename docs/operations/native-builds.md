...
workflow runs automatically for eligible same-repository pull requests targeting
`main`; it does not accept arbitrary manual commit or pull-request SHA inputs.
